;(function($) {
    ...
    var options = {
            max_value: 5,
            step_size: 0.5,
            update_input_field_name: $("#evalinput")
        }
        var optionseller = {
            max_value: 5,
            step_size: 0.5,
            update_input_field_name: $("#evalinputSeller")
        }
        
        $(".rate").rate(options);
        $(".rateseller").rate(optionseller);
...
function previewFile() {
        ...
        reader.addEventListener("load", function () {
            ...
            document.querySelector('.nav-brand').querySelector('img').src = preview.src;
